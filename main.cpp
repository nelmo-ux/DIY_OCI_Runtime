...
const std::string STATE_BASE_PATH = "/run/my_runtime/";
...
// from_json/to_jsonをnlohmann/jsonに教えることで、自動的に変換できる?(とりあえずできてそう)
